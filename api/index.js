...
// Fonction pour vérifier l'hébergement vert
async function checkGreenHosting(url) {
  try {
    ...
    console.error('Erreur Green Web:', error.message);
    return { isGreen: false, hostedBy: 'Inconnu' };
  }
}

// Fonction pour calculer le poids de la page
async function calculatePageWeight(url) {
  try {
    ...
    console.error('Erreur poids page:', error.message);
    return 2 * 1024 * 1024; // 2MB par défaut
  }
}

// Fonction pour calculer le carbone
